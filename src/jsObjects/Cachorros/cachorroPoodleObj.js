...
const cachorroPoodleObj = {
    ...
    personality: `Inteligentes, animados e companheiros.`,
    adaptationWithHumans: `Afetuosos com seus tutores, fiéis e brincalhões.`,
    physicalCharacteristics: `Pelagem fina e encaracolada.`,
    necessaryCareText: `O tipo de pelagem do Poodle , fina e encaradolada,  favorece o surgimento de nós, sendo necessário realizar a escovação diária para mantê-los desembaraçados. Utilize escovas e acessórios específicos para o tipo de pelagem. A tosa também é recomendada para a manutenção dos pelos.

Recomenda-se para os Poodles cerca de dois banhos por mês para manter a pelagem limpa e cheirosas.
...
Por ser um cão muito ativo, mantenha uma rotina com brincadeiras e exercícios.`,
    ...
    curiosityText1: `Apesar de termos a imagem do Poodle com pelo encaracolado gravada em nossa mente, o poodle também pode ter o pelo encordoado, tais com cães da raça Komondor e Puli. Tal tipo de pelagem no poodle se desenvolve naturalmente com o tempo, havendo necessidade de cuidado específico.`,
    curiosityTittle2: `ORIGEM DO NOME`,
    curiosityText2: `A palavra Poodle deriva da palavra em alemão pfudel, que significa poça. Na França era chamado de Caniche, nome que remete a sua habilidade na caça de patos.`,
    curiosityTittle3: `LONGEVIDADE`,
    curiosityText3: `São conhecidos por possuírem uma expectativa de vida bastante alta. No Alabama, Estados Unidos, um Poodle chamado Taffy Gayle viveu até os 27 anos!`,
    curiosityTittle4: `FAMOSOS`,
    curiosityText4: `Diversas personalidades famosas da história têm ou já tiveram um Poodle, nomes como Elvis Presley, Marilyn Monroe, Chopin, Rihanna e Beethoven; o último até mesmo compôs uma música para seu cão em 1787, intitulada “Elegia à Morte de um Poodle”.`,
}

export default cachorroPoodleObj;