const cachorroPitbullObj = {
    ...
    personality: `Fortes, Leais, inteligentes e enérgicos`,
    adaptationWithHumans: `Podem ser dóceis, mas depende da criação.`,
    ...
    curiosityText1: `Pitbulls são conhecidos por sua tolerância ao desconforto e capacidade de resistir à dor. Isso os tornou úteis em várias situações de trabalho, como pastoreio de gado e caça.`,
    curiosityTittle2: `Personalidade Amorosa`,
    curiosityText2: `Pitbulls são frequentemente descritos como cães afetuosos, leais e dedicados aos seus proprietários. Muitos são conhecidos por serem excelentes companheiros de família, especialmente com crianças.`,
    curiosityTittle3: `ORIGEM HISTÓRICA`,
    curiosityText3: `Os Pitbulls descendem de cães que eram originalmente criados para atividades como bull-baiting e lutas entre cães no século 19 na Inglaterra. No entanto, essas práticas foram proibidas e a raça foi redirecionada para atividades mais pacíficas, como companhia e trabalho em fazendas.`,
    curiosityTittle4: `Excelentes Atletas`,
    curiosityText4: `Pitbulls são cães muito atléticos e podem se destacar em uma variedade de esportes caninos, incluindo agilidade, frisbee, corrida e até mesmo competições de peso-pesado.`,
}

export default cachorroPitbullObj;