const PorquinhoDaIndiaObj = {
    imgIntro: "/images/pag_porquinhos_da_india_intro.png",
    ...
    lifetimeText: `Em média de 5 a 7 anos.`,
    estimatedPrice: `Pode variar dependendo da raça.`,
    personality: `Energéticos e Afetuosos.`,
    adaptationWithHumans: `Reconhece o próprio nome.`,
    physicalCharacteristics: `Pelagem densa e macia.`,
    necessaryCareText: `Ao criar um porquinho da índia como animal de estimação, é essencial proporcionar um ambiente seguro e confortável em uma gaiola espaçosa, com substrato adequado para absorção de urina e fezes. 

A dieta deve ser composta principalmente por feno de qualidade, complementado com vegetais frescos, frutas e pellets próprios para porquinhos da índia, garantindo uma alimentação balanceada.

Manter a higiene da gaiola é fundamental, limpando-a regularmente e trocando o substrato, além de fornecer água fresca diariamente. Oferecer brinquedos e objetos para roer é importante para estimular seu comportamento natural de roer e evitar o tédio.

A interação com o porquinho da índia deve ser suave e respeitosa, evitando movimentos bruscos que possam assustá-lo. Socializá-lo desde cedo pode ajudá-lo a se acostumar com a presença humana, mas lembre-se de que cada porquinho tem sua própria personalidade.

Consultas veterinárias regulares são recomendadas para monitorar sua saúde e garantir que receba os cuidados necessários ao longo da vida, incluindo exames físicos e tratamento preventivo contra parasitas.`,
    imgProduct1: "/images/riga_menu_premium_alimentacao_porquinhos_da_india.png",
    altImgProduct1: "Menu Premium Riga",
    textImageProduct1: `Menu Premium Riga`,
    imgProduct2: "/images/aime_granulado_alimentacao_porquinhos_da_india.png",
    altImgProduct2: "Granulado completo",
    textImageProduct2: `Granulado completo`,
...
export default PorquinhoDaIndiaObj;